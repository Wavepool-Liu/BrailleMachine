...
def says_api_localget(content,filename):
    ...
    if content is None:
        ...
        result = client.synthesis(content,'zh',1,{'vol':13,'per':0,'spd':5,'pit':7})
    if not isinstance(result,dict):
        with open("/home/pi/braille/MP3Database/"+filename,'wb') as f:
            f.write(result)
    print("mpg123 "+"/home/pi/braille/MP3Database/"+filename)
    os.system("mpg123 "+"/home/pi/braille/MP3Database/"+filename)

def SayLocalMp3(filename):
    address = "/home/pi/braille/MP3Database/"
...
if __name__ == '__main__':
    ...
    # says_api(result)
    # text=get_summary("汉字")
    says_api_localget("已收藏该词","GetWordsInCols.mp3")
