...
ColWords = ['学','州','粒','巧','探','刘','庆','烤','材','伴']
ColWordsShow = ['125-23456-2','34-12356-1','123-24-23','13-345-3','2345-1236-23','123-1256-2','13-16-23','13-235-3','14-246-2','12-1236-23']
        ...
        if FreWordsEna is True:
            if IO.Bottom_state_Add_Index(IoState['B2'], IoState['B1'], FreCharIndex) is True:
                ...
                try:
                    ...
                    print(FreWords[FreCharIndex])
                    r = requests.get("http://119.23.254.108:10086/postlwp",
                                     data=FreWords[FreCharIndex].encode("utf-8").decode("latin1"))
                    print(r.text)
                    aud.says_api(r.text)
                    # SaylocalEna = True
                except:
        ...
        if ColWordsEna is True:
            if IO.Bottom_state_Add_Index(IoState['B2'], IoState['B1'], ColsCharIndex) is True:
                ...
                try:
                    ...
                    toserial.serialset.APPSendTo32(Serttl, ColWordsShow[ColsCharIndex])
